...
// Filename: controller_new_popup_new_by_M.ggsk
// Generated 2021-06-02T15:42:23
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		hs='data:image/svg+xml;base64,'+
		...
		el=me._button_up=document.createElement('div');
		el.ggId="button_up";
		el.ggDx=13;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._button_up.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._button_up.onmouseout=function (e) {
			me.elementMouseDown['button_up']=false;
		}
		me._button_up.onmousedown=function (e) {
			me.elementMouseDown['button_up']=true;
		}
		me._button_up.onmouseup=function (e) {
			me.elementMouseDown['button_up']=false;
		}
		me._button_up.ontouchend=function (e) {
			me.elementMouseDown['button_up']=false;
		}
		me._button_up.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me.divSkin.appendChild(me._button_up);
		...
		me._button_down.onmouseout=function (e) {
			me.elementMouseDown['button_down']=false;
		}
		me._button_down.onmousedown=function (e) {
			me.elementMouseDown['button_down']=true;
		}
		me._button_down.onmouseup=function (e) {
			me.elementMouseDown['button_down']=false;
		}
		me._button_down.ontouchend=function (e) {
			me.elementMouseDown['button_down']=false;
		}
		...
		me._button_left.onmouseout=function (e) {
			me.elementMouseDown['button_left']=false;
		}
		me._button_left.onmousedown=function (e) {
			me.elementMouseDown['button_left']=true;
		}
		me._button_left.onmouseup=function (e) {
			me.elementMouseDown['button_left']=false;
		}
		me._button_left.ontouchend=function (e) {
			me.elementMouseDown['button_left']=false;
		}
		...
		me._button_right.onmouseout=function (e) {
			me.elementMouseDown['button_right']=false;
		}
		me._button_right.onmousedown=function (e) {
			me.elementMouseDown['button_right']=true;
		}
		me._button_right.onmouseup=function (e) {
			me.elementMouseDown['button_right']=false;
		}
		me._button_right.ontouchend=function (e) {
			me.elementMouseDown['button_right']=false;
		}
		...
		me.__3.callChildLogicBlocks_mouseover = function(){
			if(me.__3.ggInstances) {
				var i;
				for(i = 0; i < me.__3.ggInstances.length; i++) {
					if (me.__3.ggInstances[i].__5 && me.__3.ggInstances[i].__5.logicBlock_visible) {
						me.__3.ggInstances[i].__5.logicBlock_visible();
					}
				}
			}
		}
		me.__3.callChildLogicBlocks_active = function(){
			if(me.__3.ggInstances) {
				var i;
				for(i = 0; i < me.__3.ggInstances.length; i++) {
					me.__3.ggInstances[i].__5.callChildLogicBlocks_active();
				}
			}
		}
		el.ggUpdate = function(filter) {
			...
			for (var i=0; i < el.ggTagTable.length; i++) {
				...
				var parameter={};
				parameter.top=(row * me.__3.ggHeight) + 'px';
				parameter.left=(column * me.__3.ggWidth) + 'px';
			...
			me.__3.callChildLogicBlocks_active();
			me.__3.ggUpdating = false;
			player.triggerEvent('clonerchanged');
			if (me.__3.parentNode.classList.contains('ggskin_subelement') && me.__3.parentNode.parentNode.classList.contains('ggskin_scrollarea')) me.__3.parentNode.parentNode.ggUpdatePosition();
		}
		el.ggFilter = [];
		el.ggTagTable = [
			{tag:"лаборатории",title:"\u041b\u0430\u0431\u043e\u0440\u0430\u0442\u043e\u0440\u0438\u0438 \u0444\u0430\u043a\u0443\u043b\u044c\u0442\u0435\u0442\u0430 \u0424\u0418\u0418\u0422"},
			];
		el.ggId="\u042d\u0442\u0430\u0436\u0438";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		...
		el.ggFilter = [];
		el.ggInstances = [];
		me.__.callChildLogicBlocks_mouseover = function(){
			if(me.__.ggInstances) {
				var i;
				for(i = 0; i < me.__.ggInstances.length; i++) {
					if (me.__.ggInstances[i].__1 && me.__.ggInstances[i].__1.logicBlock_visible) {
						me.__.ggInstances[i].__1.logicBlock_visible();
					}
				}
			}
		}
		me.__.callChildLogicBlocks_active = function(){
			if(me.__.ggInstances) {
				var i;
				for(i = 0; i < me.__.ggInstances.length; i++) {
					me.__.ggInstances[i].__1.callChildLogicBlocks_active();
				}
			}
		}
		el.ggUpdate = function(filter) {
			if(me.__.ggUpdating == true) return;
			me.__.ggUpdating = true;
			var el=me.__;
			var curNumRows = 0;
			curNumRows = el.ggNumRepeat;
			if (curNumRows < 1) curNumRows = 1;
			...
			for (var i=0; i < el.ggTagTable.length; i++) {
				...
				nodeId['firstnode'] = cItem.firstnode;
				var parameter={};
				parameter.top=(row * me.__.ggHeight) + 'px';
				parameter.left=(column * me.__.ggWidth) + 'px';
				parameter.width=me.__.ggWidth + 'px';
				parameter.height=me.__.ggHeight + 'px';
				parameter.index=currentIndex;
				var inst = new SkinCloner___Class(nodeId, me, el, parameter);
				currentIndex++;
				el.ggInstances.push(inst);
				el.appendChild(inst.__div);
				inst.__div.ggObj=inst;
			...
			me.__.callChildLogicBlocks_mouseover();
			me.__.callChildLogicBlocks_active();
			me.__.ggUpdating = false;
			player.triggerEvent('clonerchanged');
			if (me.__.parentNode.classList.contains('ggskin_subelement') && me.__.parentNode.parentNode.classList.contains('ggskin_scrollarea')) me.__.parentNode.parentNode.ggUpdatePosition();
		}
		el.ggFilter = [];
		el.ggTagTable = [
			{tag:"лаборатории",title:"\u041b\u0430\u0431\u043e\u0440\u0430\u0442\u043e\u0440\u0438\u0438 \u0444\u0430\u043a\u0443\u043b\u044c\u0442\u0435\u0442\u0430 \u0424\u0418\u0418\u0422"},
			];
		el.ggId="\u0421\u043f\u0435\u0446\u0438\u0430\u043b\u044c\u043d\u043e\u0441\u0442\u0438 \u0444\u0430\u043a\u0443\u043b\u044c\u0442\u0435\u0442\u0430";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_cloner ";
		el.ggType='cloner';
		...
		me.__.ggUpdateConditionNodeChange=function () {
			var cnode=player.getCurrentNode();
			for(var i=0; i<me.__.childNodes.length; i++) {
				var child=me.__.childNodes[i];
				if (child.ggObj && child.ggObj.ggNodeId==cnode) {
			        var childOffX = child.offsetLeft;
			        var childOffY = child.offsetTop;
					var p = child.parentElement;
	...
	me.skinTimerEvent=function() {
		...
		if (me.elementMouseDown['button_up']) {
			player.changeTiltLog(0.5,true);
		}
		if (me.elementMouseDown['button_down']) {
			player.changeTiltLog(-0.5,true);
		}
		if (me.elementMouseDown['button_left']) {
			player.changePanLog(0.5,true);
		}
		if (me.elementMouseDown['button_right']) {
			player.changePanLog(-0.5,true);
		}
	...
	function SkinCloner__3_Class(item, parentScope,ggParent,parameter) {
		var me=this;
		var hs='';
		...
		me.__div.setAttribute('style','position: absolute;width: 99px; height: 25px; visibility: inherit; overflow: visible;');
		...
		hs+='width: 298px;';
		hs+='height: 26px;';
		hs+='background: #f2edc4;';
		hs+='border: 1px solid #be2e25;';
		hs+='border-radius: 12px;';
		hs+=cssPrefix + 'border-radius: 12px;';
		hs+='color: rgba(190,46,37,1);';
		hs+='font-size: 14px;';
		hs+='font-weight: bold;';
		...
		el.ggFilter = [];
		el.ggInstances = [];
		me.__5.callChildLogicBlocks_active = function(){
			if(me.__5.ggInstances) {
				var i;
				for(i = 0; i < me.__5.ggInstances.length; i++) {
					if (me.__5.ggInstances[i].__6 && me.__5.ggInstances[i].__6.logicBlock_backgroundcolor) {
						me.__5.ggInstances[i].__6.logicBlock_backgroundcolor();
					}
				}
			}
		}
		el.ggUpdate = function(filter) {
			...
			filter=filter.concat(parentScope.__3.ggFilter);
			if (me.ggTag) filter.push(me.ggTag);
			filter=filter.sort();
			...
			for (var i=0; i < tourNodes.length; i++) {
				...
				if (passed) {
				var parameter={};
				parameter.top=(row * me.__5.ggHeight) + 'px';
				parameter.left=(column * me.__5.ggWidth) + 'px';
				parameter.width=me.__5.ggWidth + 'px';
				parameter.height=me.__5.ggHeight + 'px';
				parameter.index=currentIndex;
			...
			me.__5.callChildLogicBlocks_active();
			me.__5.ggUpdating = false;
			player.triggerEvent('clonerchanged');
			if (me.__5.parentNode.classList.contains('ggskin_subelement') && me.__5.parentNode.parentNode.classList.contains('ggskin_scrollarea')) me.__5.parentNode.parentNode.ggUpdatePosition();
		}
		el.ggFilter = [];
		el.ggId="\u041b\u0430\u0431\u043e\u0440\u0430\u0442\u043e\u0440\u0438\u0438";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		me.__5.ggCurrentLogicStateVisible = -1;
		...
		me.__5.ggNodeChange=function () {
			me.__5.ggUpdateConditionNodeChange();
		}
		me.__4.appendChild(me.__5);
		me.__div.appendChild(me.__4);
	};
	function SkinCloner___Class(item, parentScope,ggParent,parameter) {
		var me=this;
		var hs='';
		me.parentScope=parentScope;
		me.ggParent=ggParent;
		...
		hs+='overflow-y: auto;';
		els.setAttribute('style',hs);
		els.innerHTML="\u0421\u043f\u0435\u0446\u0438\u0430\u043b\u044c\u043d\u043e\u0441\u0442\u0438 \u0444\u0430\u043a\u0443\u043b\u044c\u0442\u0435\u0442\u0430";
		el.appendChild(els);
		...
		el.ggFilter = [];
		el.ggInstances = [];
		me.__1.callChildLogicBlocks_active = function(){
			if(me.__1.ggInstances) {
				var i;
				for(i = 0; i < me.__1.ggInstances.length; i++) {
					if (me.__1.ggInstances[i].__2 && me.__1.ggInstances[i].__2.logicBlock_backgroundcolor) {
						me.__1.ggInstances[i].__2.logicBlock_backgroundcolor();
					}
				}
			}
		}
		el.ggUpdate = function(filter) {
			...
			if (parentScope.ggTag) filter.push(parentScope.ggTag);
			filter=filter.concat(parentScope.__.ggFilter);
			if (me.ggTag) filter.push(me.ggTag);
			filter=filter.sort();
			if ((el.ggNumCols == curNumCols) && (el.ggInstances.length > 0) && (filter.length === el.ggCurrentFilter.length) && (filter.every(function(value, index) { return value === el.ggCurrentFilter[index] }) )) {
			...
			for (var i=0; i < tourNodes.length; i++) {
				...
				if (passed) {
				var parameter={};
				parameter.top=(row * me.__1.ggHeight) + 'px';
				parameter.left=(column * me.__1.ggWidth) + 'px';
			...
			me.__1.callChildLogicBlocks_active();
			me.__1.ggUpdating = false;
			player.triggerEvent('clonerchanged');
			if (me.__1.parentNode.classList.contains('ggskin_subelement') && me.__1.parentNode.parentNode.classList.contains('ggskin_scrollarea')) me.__1.parentNode.parentNode.ggUpdatePosition();
		}
		el.ggFilter = [];
		el.ggId="\u0421\u043f\u0435\u0446\u0438\u0430\u043b\u044c\u043d\u043e\u0441\u0442\u044c";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=false;
		el.className="ggskin ggskin_cloner ";
		el.ggType='cloner';
	...
	function SkinCloner__5_Class(nodeId, parentScope,ggParent,parameter) {
		...
		me.elementMouseOver={};
		me.__div=document.createElement('div');
		me.__div.setAttribute('style','position: absolute;width: 435px; height: 28px; visibility: inherit; overflow: visible;');
		me.__div.style.left=parameter.left;
		me.__div.style.top=parameter.top;
		me.__div.style.width=parameter.width;
		me.__div.style.height=parameter.height;
		...
		me.__6.logicBlock_backgroundcolor = function() {
			...
			if (me.__6.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				...
				me.__6__text.style[domTransition]='background-color 0s';
				if (me.__6.ggCurrentLogicStateBackgroundColor == 0) {
					me.__6__text.style.backgroundColor="rgba(243,238,198,1)";
				}
				else {
					me.__6__text.style.backgroundColor="rgba(248,247,222,1)";
				}
			}
		}
		...
		me.__div.appendChild(me.__6);
		el=me._container_0=document.createElement('div');
		el.ggPermeable=false;
		el.ggId="Container \u043b\u0430\u0431-\u0438\u0438";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_container ";
		el.ggType='container';
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._container_0.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._container_0.ggUpdatePosition=function (useTransition) {
		}
		me.__div.appendChild(me._container_0);
	};
	function SkinCloner__1_Class(nodeId, parentScope,ggParent,parameter) {
		...
		me.__2.logicBlock_backgroundcolor = function() {
			...
			if (me.__2.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				...
				me.__2__text.style[domTransition]='background-color 0s';
				if (me.__2.ggCurrentLogicStateBackgroundColor == 0) {
					me.__2__text.style.backgroundColor="rgba(243,238,198,1)";
				}
				else {
					me.__2__text.style.backgroundColor="rgba(248,247,222,1)";
				}
			}
		}
		...
		me.__div.appendChild(me.__2);
		el=me._container_=document.createElement('div');
		el.ggPermeable=false;
		el.ggId="Container \u0441\u043f\u0435\u0446-\u0442\u044c";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_container ";
		el.ggType='container';
		...
		me._container_.ggUpdatePosition=function (useTransition) {
		}
		me.__div.appendChild(me._container_);
	};
	me.addSkin();
	...
	player.addListener('mouseover', function(args) { me.__3.callChildLogicBlocks_mouseover();me.__.callChildLogicBlocks_mouseover(); });
	player.addListener('changenode', function(args) { me.__3.callChildLogicBlocks_active();me.__.callChildLogicBlocks_active(); });
